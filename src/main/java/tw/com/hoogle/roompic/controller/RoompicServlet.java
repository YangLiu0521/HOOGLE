...
//				
	...
	if ("getOne_For_Update".equals(action)) { // 來自listAllRoom.jsp的請求
			...
			req.setAttribute("errorMsgs", errorMsgs);
				...
				RequestDispatcher successView = req.getRequestDispatcher(url);// 成功轉交 update_roompic_input.jsp
				successView.forward(req, res);
		}
//		
//		
...
//			/***************************2.開始新增資料***************************************/
			RoompicService roompicSvc = new RoompicService();
			roompicSvc.addRoompic (roomAuto,roomType,roompicPic);
			
//			/***************************3.新增完成,準備轉交(Send the Success view)***********/
			String url = "/roompic/listAllRoom.jsp";
