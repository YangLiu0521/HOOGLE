...
//		if ("getOrddetail_For_Display".equals(action)) { // 來自select_page.jsp的請求
...
//			List<OrdVO> ordVO  = ordSvc.getOneOrdDetail(ordId);
//			if (ordVO == null) {
