...
public class HotelDAO implements HotelDAO_interface{
	...
	private static final String GET_ALL_STMT = "SELECT hotelEmail,hotelPassword,hotelName,hotelPhone,hotelPrincipal,hotelTaxid,hotelCounty,hotelAddress,hotelType,hotelNotice,hotelQa,hotelIntroduction,hotelState FROM hotel";
	...
	public HotelVO findByPrimaryKey(Integer hotelId) {
		...
		try {
			...
			while (rs.next()) {
				...
				hotelVO.setHotelIntroduction(rs.getString("Introduction"));
