...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
    ...
    <!-- bootstrap core CSS -->
    <link rel="stylesheet" href="/datetimepickercss/bootstrap.min.css" />
    <!-- font awesome -->
    <link href="/datetimepickercss/all.min.css" rel="stylesheet" />
    <!-- owl carousel -->
    <link href="datetimepicker/css/owl.carousel.min.css" rel="stylesheet" />
    <link href="/datetimepickercss/owl.theme.default.min.css" rel="stylesheet" />
    <!-- venobox css -->
    <link rel="stylesheet" href="/datetimepicker/css/venobox.css" />
    <!-- datepicker css -->
    <link rel="stylesheet" href="/datetimepickercss/datepicker.min.css" />
    <!-- custom styles for this template -->
    <link href="/datetimepickercss/custom.css" rel="stylesheet" />
    <link href="/datetimepickercss/responsive.css" rel="stylesheet" />
    <link href="/datetimepickercss/helper.css" rel="stylesheet" />
</head>
<body>
	<!-- ================ Preloader ================ -->
<!--     <div id="preloader"> -->
...
<!--     </div> -->
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdown02">
                        <a class="dropdown-item" href="destinations.html"
                          >Destinations</a
                        >
                        <a class="dropdown-item" href="destination-detail.html"
                    ...
                    <li class="nav-item dropdown active">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdown05">
                        <a class="dropdown-item" href="listing.html"
                          >Hotel Listing</a
                        >
                        <a class="dropdown-item" href="hotel-detail.html"
                          >Hotel Detail</a
                        >
                        ...
                        <a
                          class="dropdown-item"
                          href="traveler-information.html"
                          >Traveler Information</a
                        >
                        <a class="dropdown-item" href="payment-information.html"
            ...
            <div class="col-lg-4 col-md-6 col-sm-8 col-10 text-right">
              ...
              <div class="header-right-link">
                <ul>
                  ...
                  <li>
                    <a href="contact-us.html" class="header-request"
                      >Request a Quote</a
                    >
                  </li>
                </ul>
    ...
    <!-- js files -->
    <script src="/datetimepicker/js/jquery-3.5.1.min.js"></script>
    <script src="/datetimepicker/js/bootstrap.bundle.min.js"></script>
    <!-- counter js -->
    <script src="/datetimepicker/js/jquery-1.10.2.min.js"></script>
    <script src="/datetimepicker/js/waypoints.min.js"></script>
    <script src="/datetimepicker/js/jquery.counterup.min.js"></script>
    <!-- venobox js -->
    <script src="/datetimepicker/js/venobox.min.js"></script>
    <!-- owl carousel -->
    <script src="/datetimepicker/js/owl.carousel.min.js"></script>
    <!-- portfolio js -->
    <script src="/datetimepicker/js/jquery.mixitup.min.js"></script>
    <!-- datepicker js -->
    <script src="/datetimepicker/js/datepicker.min.js"></script>
    <!-- script js -->
    <script src="/datetimepicker/js/custom.js"></script>
</body>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/all.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/bootstrap.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/carousel.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/theme.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/venobox.css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/datepicker.css" />
<%-- <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/custom.css" /> --%>
<%-- <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/helper.css" /> --%>
<%-- <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/datetimepicker/css/responsive.css" /> --%>
