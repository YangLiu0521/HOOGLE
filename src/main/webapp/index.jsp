...
<body>
  ...
  <header class="header">
    <!-- header upper -->
    <div class="header-upper-bar header-upper-test">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-lg-8 col-md-6 col-sm-4 col-2">
            ...
            <nav class="navbar header-navigation navbar-expand-lg p-0">
              ...
              <div class="collapse navbar-collapse" id="navbarTheme">
                <ul class="navbar-nav align-items-start align-items-1g-center">
                  <li class="active"><a class="nav-link" href="index.jsp">首頁</a></li>
                  <li><a class="nav-link" href="index.jsp">比價</a></li>
                  <li><a class="nav-link" href="index.jsp">美食</a></li>
          ...
          <div class="col-lg-4 col-md-6 col-sm-8 col-10 text-right">
            ...
            <div class="header-right-link" id="header">
              <ul>
<%--               <li class="header-singin"><a href="<%=request.getContextPath()%>/user/registerForWho.jsp"><i class="fas fa-pen"></i> 註冊</a></li>  --%>
<%--               <li class="header-singin"><a href="<%=request.getContextPath()%>/user/loginForWho.jsp"><i class="fas fa-user"></i> 登入</a></li> --%>
<!--                 <li><a href="registerForWho.html"><i class="fas fa-pen"></i> 註冊</a></li> -->
<!--                 <li><a href="loginForWho.html"><i class="fas fa-user"></i> 登入</a></li> -->
        ...
        <div class="row">
          <div class="col-lg-6 col-md-8 col-sm-12 col-12 offset-xl-0 offset-lg-3 offset-sm-0">
            <div class="center-search">
              <h1 class="text-white">享受你的旅程～～</h1>
              <p class="text-white">搜尋訂房</p>
              <form class="form-style-1">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="搜尋城市">
                </div>
                <div class="row">
                ...
                <button type="submit" class="btn-style-1 w-100">搜尋</button>
              </form>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-30">
          ...
          <div class="blog-box shadow">
            ...
            <div class="blog-des">
              ...
              <p class="text-muted">Lorem ipsum dolor sit amet consectetur ipiscing elit amet consectetur piscing elit
      ...
      <div class="popular-hotel-carousel owl-carousel owl-theme">
        <div class="item">
          ...
          <div class="popular-hotel-box">
            ...
            <div class="reting"> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-6 mb-30">
            ...
            <!-- text -->
            <div class="text">
              <p>Lorem ipsum dolor sit amet sectetur adipiscing elit amet consectetur scing elit amet consectetur
            ...
            <div class="footer-social"> <a href=""><i class="fab fa-facebook-square"></i></a> <a href=""><i
                  class="fab fa-twitter-square"></i></a> <a href=""><i class="fab fa-linkedin"></i></a> <a href=""><i
                  class="fab fa-pinterest-square"></i></a> <a href=""><i class="fab fa-google-plus-square"></i></a>
            </div>
            <!-- footer social end -->
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 mb-30">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 mb-30">
            ...
            <div class="footer-recent-post">
              ...
              <div class="footer-recent-post-item"> <a href="">
                  ...
                  <small><i class="far fa-calendar-alt pr-6"></i> 01 Oct 2020</small>
                </a> </div>
